...
var radialoptions1, radialchart1, radialChartColors = getChartColorsArray("radialchart-11");
radialChartColors && (radialoptions1 = {
    series: [10],
    chart: {
        type: "radialBar",
...
}, (radialchart1 = new ApexCharts(document.querySelector("#radialchart-11"), radialoptions1)).render());
var radialoptions1, radialchart1, radialChartColors = getChartColorsArray("radialchart-12");
radialChartColors && (radialoptions1 = {
    series: [24],
    chart: {
        type: "radialBar",
...
}, (radialchart1 = new ApexCharts(document.querySelector("#radialchart-12"), radialoptions1)).render());
