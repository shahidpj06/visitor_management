...
lineChartColors && (dom = document.getElementById("line-chart"), myChart = echarts.init(dom), app = {}, option = null, option = {
    grid: {
        zlevel: 0,
        x: 50,
        x2: 50,
...
mixLineChartColors && (dom = document.getElementById("mix-line-bar"), myChart = echarts.init(dom), option = null, (app = {}).title = "Data view", option = {
    grid: {
        zlevel: 0,
        x: 80,
        x2: 50,
